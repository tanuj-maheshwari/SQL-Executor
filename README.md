...
The unit tests provided cover 99% percent of the code. Below is a sanpshot of the code coverage report generated by jacoco.

[JaCoCo Report](./img/Coverage.png)
